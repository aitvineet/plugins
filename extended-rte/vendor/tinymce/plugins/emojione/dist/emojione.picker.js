...
(function ( $ ) {
     $.fn.emojionePicker = function(options, editorInstance, emojiContainerId, afterEmojiInsertCb) {
		...
		var emojiList = {
			...
			food: {
				header: ":hamburger:",
				content: ":grapes: :melon: :watermelon: :tangerine: :lemon: :banana: :pineapple: :apple: :green_apple: :pear: :peach: :cherries: :strawberry: :kiwi: :tomato: :avocado: :potato: :carrot: :corn: :hot_pepper: :cucumber: :peanuts: :bread: :croissant: :french_bread: :pancakes: :cheese: :meat_on_bone: :poultry_leg: :bacon: :hamburger: :fries: :pizza: :hotdog: :taco: :burrito: :stuffed_flatbread: :egg: :cooking: :shallow_pan_of_food: :stew: :salad: :popcorn: :bento: :rice_cracker: :rice_ball: :rice: :curry: :ramen: :spaghetti: :sweet_potato: :oden: :sushi: :fried_shrimp: :fish_cake: :dango: :icecream: :shaved_ice: :ice_cream: :doughnut: :cookie: :birthday: :cake: :chocolate_bar: :candy: :lollipop: :custard: :honey_pot: :baby_bottle: :milk: :coffee: :tea: :sake: :champagne: :wine_glass: :cocktail: :tropical_drink: :beer: :beers: :champagne_glass: :tumbler_glass: :fork_knife_plate: :fork_and_knife: :spoon:".split( " " )
				/*:eggplant:*/
			},
			objects: {
				header: ":bulb:",
		...
		{
			$( '<div class="emojiOneWrapper"><div class="' + emojiContainerCls + '" id="' + emojiContainer + '"><nav></nav></div></div>' ).insertAfter( el );
			...
			// EMOJI CLICK EVENT
			$( document ).off( "click touchstart", "#"  + emojiContainer +  " section .emojione" );
			$( document ).on( "click touchstart", "#"  + emojiContainer +  " section .emojione",
				function()
				{		
					/*var caretPos = activeEl.selectionStart;
					var textAreaTxt = $( activeEl ).val();*/

					$(".show-menu-bar-on-focus").addClass('emoji-clicked');
					var txtToAdd;
					if( settings.type == "shortcode" )
					{
						shortCode = $( this ).attr( "title" ) + " ";
						emojione.sprites = 0;
						txtToAdd = emojione.shortnameToImage(shortCode);
						emojione.sprites = 1;
						var txtToAdd = txtToAdd.replace(/alt=[^(.w >]*"/gi,"alt='"+ shortCode +"'");
						txtToAdd = txtToAdd.replace("emojione",'emojione-trellis') 

					}else{
						txtToAdd = $( this ).attr( "alt" ) + " ";
					}

					editorInstance.insertContent(txtToAdd);					
					//console.log('editorInstance',editorInstance);
					afterEmojiInsertCb(txtToAdd);					
				}
			);
		};
		...
		var loadEmojies = function( section )
		{
			...
			$( '<section class="' + section + '">' + sectionHtml + '</section>' ).insertBefore( "#"  + emojiContainer +  " nav" );
		...
		{	
			...
			script.src = 'https://gitcdn.link/repo/aitvineet/plugins/dev/extended-rte/vendor/tinymce/plugins/emojione/dist/emojione_jsdeliver.min.js';
			/*style.type = "text/css";
			...
			script.onload = function()
			{
				...
				$( ".emojionepicker-picker, .mce-i-emoji" ).click(
					function()
					{
